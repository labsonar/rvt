...
def main():
    ...
    dataloaders = rvt_ml.AudioDataset.get_dataloaders()
    ...
    output_dir = "./data/ml/mlp"

    # input_size = next(iter(train_loader))[0].shape[1]
    # model = lps_ml.MLP(input_size, hidden_channels=[32], n_targets=1, dropout=0.2)
    ...
    model = lps_ml.MLP.load(os.path.join(output_dir, "model.pkl"))
